	...
	{ -- Fuzzy Finder (files, lsp, etc)
        ...
        extensions = {
          ...
          --entry_prefix = " ・ ",
					...
					layout_config = {
            width = function(_, cols, _) if cols > 200 then return 170 else return math.floor(cols * 0.87) end
            end, preview_cutoff = 120
					--	width = 120.0,
					},
				},
			...
			vim.keymap.set("n", "<leader>t", builtin.colorscheme, { desc = "TSCP COLORSCHEMES" })
