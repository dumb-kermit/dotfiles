		...
		opts = function()
			...
			local config = {
				...
				items = {
					...
					new_section("SCOPE THEMES", "Telescope colorscheme", "COLORSCOPE"),
					new_section("SWEETIE", "colorscheme sweetie", "TRUE COLORS"),
					new_section("GRUVBOX", "colorscheme gruvbox-material", "TRUE COLORS"),
					new_section("WAVE", "colorscheme kanagawa", "TRUE COLORS"),
					new_section("DRAGON", "colorscheme kanagawa-dragon", "TRUE COLORS"),
