...
return {
	{
		...
		lazy = true,
		keys = {
			{ "<leader>b", "<cmd>Telescope file_browser path=%:p:h select_buffer=true<CR>", desc = "SCOPE FILES" },
		},
	},
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>t", builtin.colorscheme, { desc = "SCOPE THEMESZ" })
			vim.keymap.set("n", "<leader>k", function()
				builtin.keymaps(require("telescope.themes").get_ivy({}))
